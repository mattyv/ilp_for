...
#define ILP_NO_SANITIZE_UNSIGNED_OVERFLOW
    ...
    namespace detail {
        ...
        // typed path (ILP_FOR_T family) this file exercises. The untyped-path
        // overload above is declared because macro_for's body names
        // for_loop_untyped_impl unconditionally - see godbolt_examples/INSTRUCTIONS.md.
